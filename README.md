...
* Фаза №1 завершена, 19 августа 2017.  
* Фаза №2 (редактура, переформатирование, небольшой тюнинг имён и терминов):
`[#####>---------------------------------------------] (11%)`

**Пожалуйста, не копируйте этот текст для распространения, пока редактура ещё не завершена.** Я планирую сделать это 20-21 августа. 
